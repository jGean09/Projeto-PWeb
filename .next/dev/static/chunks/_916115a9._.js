...
function Page() {
    ...
    async function loadItems(searchTerm, currentPage) {
        ...
        setLoading(true);
        try {
            const url = searchTerm ? `https://api.jikan.moe/v4/anime?q=${searchTerm}&page=${currentPage}` : `https://api.jikan.moe/v4/seasons/now?page=${currentPage}`; // <-- aqui a mudança
...
_s(Page, "6B0tPREMfhLTDGO2ZZFzl0E4m2o=", false, function() {
    return [
...
//# sourceMappingURL=_916115a9._.js.map